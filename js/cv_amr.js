...
sh = div => { _menu.forEach(it => hide(it.id)); show(div) }
...
function titulos() {
    ...
    `
    _titulos.forEach(it => idTitulos.innerHTML += tpl(it.titulo, it.universidad))
}
...
let _puestos = [
    {
        ...
        "modulos": ["Aplicaciones web", "Seguridad informática", "Lenguajes de marcas"],
    },
    {
        ...
        "modulos": ["Acceso a datos", "Programación multimedia y dispositivos móviles"],
    ...
    },
    {
        ...
        "fecha": "Curso 2021-22",
        "cargo": "Catedrático de informática",
        "modulos": ["Programación", "Acceso a datos", "Bases de datos"],
    },
    {
        "empresa": "IES Clara del Rey",
    ...
    },
    {
        ...
        "modulos": ["Lenguajes de marcas", "Programación", "Programación multimedia y dispositivos móviles", "Desarrollo de Funciones en el Sistema Informático"],
    ...
    },
    {
        ...
        "cargo": "Profesor de informática",
        "modulos": ["Programación en Lenguajes Estructurados", "Desarrollo de Funciones en el Sistema Informático"],
    ...
    },
    {
        ...
        "modulos": ["Linux", "Software Libre", "Web 2.0"],
    },
    {
    ...
    },
    {
        ...
        "modulos": ["Programación en Lenguajes Estructurados", "Desarrollo de Funciones en el Sistema Informático", "Fundamentos de programación", "Sistemas gestores de bases de datos"],
        "descripcion": "Grupo de gestión de calidad"
    },
    {
        "empresa": "IES La Arboleda de Alcorcón (Madrid)",
        "fecha": "Cursos 2003-04 al 2004-05",
        "cargo": "Profesor de informática",
    ...
    },
    {
        ...
        "descripcion": ["Plataformas de formación a distancia", "Proyecto Mentor", "Formación del profesorado a distancia"]
    },
    {
        "empresa": "IES La Arboleda de Alcorcón (Madrid)",
        "fecha": "Curso 2000-01",
        "cargo": "Profesor de informática y jefe del departamento de informática y comunicaciones",
        "modulos": ["Sistemas Gestores de Bases de Datos", "Desarrollo de Funciones en el Sistema Informático"],
        "descripcion": ""
    },
    {
        "empresa": "IES La Arboleda de Alcorcón (Madrid)",
    ...
    },
    {
        ...
        "cargo": "Profesor de informática",
        "modulos": ["Lenguajes de 4ª generación y herramientas CASE", "Formación en Centros de Trabajo"],
        "descripcion": ""
    },
    {
        "empresa": "Ministerio de Educación y Ciencia",
...
function puestos() {
    ...
    _puestos.forEach(it => idPuestos.innerHTML += (tpl(it.empresa, it.fecha, it.cargo, it.modulos ?? "", it.descripcion ?? "")))
}

let _proyectos = [
    {
        "empresa": "Software libre",
        "descripcion": ["Internal Message", "Internal Calendar", "Internal ClassRoom"],
    ...
    {
        "empresa": "Documenta Organización",
        "descripcion": ["Diseño del Sistema de Gestión Documental Automatizado de la compañía ENDESA", "Mecanización del Archivo fotográfico de la Revista DIEZ MINUTOS del Grupo Hachette", "Mecanización del catálogo de la biblioteca del Ministerio de Cultura"],
        "herramientas": "C, MNS y BRS/Search en UNIX SCO"
    },
    {
        "empresa": "Documenta Organización",
        "descripcion": ["Proyecto docuNAUTA. Software de gestión documental de archivos", "Diseño del registro de entrada/salida y flujo documental de la entidad SEOPAN"],
...
function proyectos() {
    ...
    `
    _proyectos.forEach(it => idProyectos.innerHTML += (tpl(it.empresa, it.descripcion, it.herramientas ?? "")))
}
...
function ponencias() {
    ...
    `
    _ponencias.forEach(it => idPonencias.innerHTML += (tpl(it.titulo, it.lugar)))
}

let _libros = [
    { "titulo": "Manual de Instalación de MAX 12.0", "editorial": "Comunidad de Madrid.", "autoria": "[Coautoría]" },
    { "titulo": "Manual de Instalación de MAX 11.0", "editorial": "Comunidad de Madrid.", "autoria": "[Coautoría]" },
    { "titulo": "Manual de Instalación de MAX 10.0", "editorial": "Comunidad de Madrid.", "autoria": "[Coautoría]" },
    { "titulo": "Manual de Instalación de MAX 9.0", "editorial": "Comunidad de Madrid.", "autoria": "[Coautoría]" },
    { "img": "img/max8.png", "titulo": "Manual de Instalación de MAX 8.0", "editorial": "Comunidad de Madrid. 2015.", "autoria": "[Coautoría]" },
    { "img": "img/max7.jpg", "titulo": "Manual de Instalación de MAX 7.0", "editorial": "Comunidad de Madrid. 2012.", "autoria": "[Coautoría]" },
    { "img": "img/max6.jpg", "titulo": "Manual de Instalación de MAX 6.0", "editorial": "Comunidad de Madrid. 2010.", "autoria": "[Coautoría]" },
    { "img": "img/max50.png", "titulo": "Manual de Instalación de MAX 5.0", "editorial": "Comunidad de Madrid. 2009.", "autoria": "[Coautoría]" },
    { "img": "img/max50.png", "titulo": "Guía de Referencia de MAX 5.0", "editorial": "Comunidad de Madrid. 2009.", "autoria": "[Coautoría]" },
    { "img": "img/max40.png", "titulo": "Manual de Instalación de MAX 4.0", "editorial": "Comunidad de Madrid. 2008.", "autoria": "[Coautoría]" },
    { "img": "img/max40.png", "titulo": "Guía de Referencia de MAX 4.0", "editorial": "Comunidad de Madrid. 2008.", "autoria": "[Coautoría]" },
    { "img": "img/max30.png", "titulo": "Guía de Instalación de MAX 3.0", "editorial": "Comunidad de Madrid. 2007.", "autoria": "[Coautoría]" },
    { "img": "img/max30.png", "titulo": "Guía de Utilización de MAX 3.0", "editorial": "Comunidad de Madrid. 2007.", "autoria": "[Coautoría]" },
    { "img": "img/tutoreinternet.jpg", "titulo": "Tutor e Internet", "editorial": "CNICE-MEC. 2006.", "autoria": "[Coautoría]" },
    { "img": "img/max.png", "titulo": "MAX, Madrid Linux, v.2.0. Manual de instalación", "editorial": "Comunidad de Madrid. 2006.", "autoria": "[Coautoría]" },
    { "img": "img/max.png", "titulo": "MAX, Madrid Linux, v.2.0. Manual de utilización por el usuario", "editorial": "Comunidad de Madrid. 2006.", "autoria": "[Coautoría]" },
    { "img": "img/tutoreseinternet.png", "titulo": "Tutores e internet", "editorial": "CNICE-MECD. 2003.", "autoria": "[Coautoría]" },
    { "img": "img/hotpotatoes.png", "titulo": "Aplicaciones Educativas con HOT POTATOES", "editorial": "CNICE-MECD. 2002.", "autoria": "[Asesoría técnica]" },
    { "img": "img/videodigitalymultimedia.png", "titulo": "Vídeo Digital y Multimedia", "editorial": "PNTIC-MEC. 1998.", "autoria": "[Coautoría]" },
    { "img": "img/clipper.png", "titulo": "Guía Práctica de Clipper 5.2.", "editorial": "Anaya Multimedia. 1994.", "autoria": "[Coautoría]" },
    { "img": "img/pooclipper.png", "titulo": "Programación Orientada al Objeto en Clipper.", "editorial": "Anaya Multimedia. 1993.", "autoria": "[Autoría]" }
]
...
function libros() {
    ...
    `
    _libros.forEach(it => idLibros.innerHTML += (tpl(it.img ?? "img/max.png", it.titulo, it.editorial, it.autoria)))
}

let _cursos = [
    {"curso": "Fundamentos de los servicios de computación en la nube", "lugar": "Instituto Superior Madrileño de Innovación Educativa"},
    {"curso": "Mentores de funcionarios en prácticas", "lugar": "Instituto Superior Madrileño de Innovación Educativa"},
    {"curso": "Plan digital Virgen de la Paloma", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Google Workspace for Education", "lugar": "Formación permanente del profesorado - Comunidad de Madrid"},
    {"curso": "Introducción a la programación de videojuegos con Unity", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Big Data, Python fundamentals y bases de datos NoSQL", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "El impacto del RGPD en los centros educativos", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Programación en Python", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Función tutorial en el aula virtual del CRIF Las Acacias", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Creación de cursos Moodle orientados a metodologías activas", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "How to teach subjects in english in vocational", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Programación I. Introducción al uso de nuevas tecnologías en el aula. ", "lugar": "CodeMadrid - Comunidad de Madrid"},
    {"curso": "El aula virtual como recurso educativo en la Formación Profesional", "lugar": "CTIF Madrid-Capital - Comunidad de Madrid"},
    {"curso": "Desarrollo en HTML5, CSS y Javascript de WebApps, incluyendo móviles FirefoxOS", "lugar": "Miriada X / UPM"},
    {"curso": "Android: Programación de Aplicaciones ", "lugar": "Miriada X / UPV"},
    {"curso": "Diseño de presentaciones y su publicación en web ", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Servicios web de Google para la enseñanza ", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Elaboración de cursos Moodle y tutorización en el Aula Virtual de EducaMadrid ", "lugar": "CRIF Las Acacias - Comunidad de Madrid"},
    {"curso": "Joomla! La web en entornos educativos ", "lugar": "Formación del Profesorado - CNICE - MEPSYD"},
    {"curso": "Tutores en la red ", "lugar": "efepeline - Comunidad de Madrid"},
    {"curso": "Aprendizaje virtual con Moodle ", "lugar": "CAP de Retiro"},
    {"curso": "Seminario de Coordinadores TIC (ver)", "lugar": "CAP de Retiro"},
    {"curso": "Internetworking ", "lugar": "FYCSA - Comunidad de Madrid"},
    {"curso": "Java, JSP ", "lugar": "Subdirección General de Tratamiento de la Información - MECD"},
    {"curso": "Interwoven ", "lugar": "GFI Informática"},
    {"curso": "Perfeccionamiento para el ejercicio de la Función Directiva en Centros Educativos ", "lugar": "CSI-CSIF - MECD"},
    {"curso": "Tutoría Telemática a Distancia", "lugar": "Formación del Profesorado - CNICE - MECD"},
    {"curso": "Administración de base de datos ORACLE ", "lugar": "ORACLE Ibérica"},
    {"curso": "Windows NT ", "lugar": "CPR de Alcorcón-Madrid"},
    {"curso": "Verity Search97 ", "lugar": "ADD Servicios Informaticos"},
    {"curso": "Java ", "lugar": "MENTOR - PNTIC - MEC"},
    {"curso": "Tutoría Telemática ", "lugar": "MENTOR - PNTIC - MEC"},
    {"curso": "Seguridad en Internet ", "lugar": "Internet Publishing Services (IPS)"},
    {"curso": "Gestión de NOVELL 4.1 ", "lugar": "Informática El Corte Inglés"},
    {"curso": "Jornadas sobre la Reforma de la Selectividad", "lugar": "Universidad Autónoma de Madrid"},
    {"curso": "Jornada sobre Internet en la Administración ", "lugar": "MEC"},
    {"curso": "Telemática IBERTEX. Aplicaciones educativas ", "lugar": "PNTIC - MEC"},
    {"curso": "Informática Avanzada ", "lugar": "CPR de Hortaleza-Madrid"},
    {"curso": "Software de gestión de bibliotecas ABSYS ", "lugar": "Servicios de Teledocumentación BARATZ"},
    {"curso": "Sistemas de archivo electrónico ", "lugar": "Documenta Organización"},
    {"curso": "Invesdoc/Invescold ", "lugar": "Investrónica"},
    {"curso": "Diseño y Programación Orientada a Objetos ", "lugar": "Documenta Organización"},
    {"curso": "Hypermedia/Hypercard para Macintosh ", "lugar": "Facultad de Informática de la UPM"},
    {"curso": "Documentación y Nuevas Tecnologías ", "lugar": "Documenta Organización"},
    {"curso": "BRS/Search ", "lugar": "Servicios de Teledocumentación BARATZ"},
    {"curso": "MEGADOC y DOCSYST ", "lugar": "Philips Informática y Comunicaciones"},
    {"curso": "P4000, DINOS y COBOL ", "lugar": "Philips Informática y Comunicaciones"},
    {"curso": "Architec y CASE ", "lugar": "Audihispana Auditores"},
    {"curso": "Powerhouse y 4GL ", "lugar": "Audihispana Auditores"},
    {"curso": "Técnico de Sistemas VAX/VMS ", "lugar": "CTD"},
    {"curso": "Sistemas de microfilm ", "lugar": "CTD"},
]
...
function cursos() {
    ...
    `
    _cursos.forEach(it => idCursos.innerHTML += (tpl(it.curso, it.lugar)))
}
